...
export default function Verify() {
    ...
    const sendOTP = async () => {
        try {
            const response = await axios.post("https://great-indian-resturant-backend.vercel.app/send-otp", { email });
    ...
    const verifyOTP = async () => {
        try {
            const response = await axios.post("https://great-indian-resturant-backend.vercel.app/verify-otp", { email, otp });
            if (response.data.success) {
